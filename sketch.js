...
star1 = loadImage("one_star.png")
starfull = loadImage("stars.png")
...
starstore=createSprite(50,20,30,30)
starstore.scale=0.2
starstore.addImage("0s",nostar)
starstore.addImage("1s",star1)
starstore.addImage("fs",starfull)
...
{
star.destroy()
starstore.changeImage("1s")
}

if(collide(fruit,star2,20)==true)
{
star2.visible=false
starstore.changeImage("fs")
}
...
function collide(body,sprite,mydist)
{
  if(body!=null)
        {
